        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center">
          <div className="animate-fade-in space-y-8">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Answer strategic questions and receive personalized frameworks covering market positioning, brand strategy, and growth plans.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button 
                ...
                className="btn-gradient h-14 px-10 text-base font-semibold glow-cyan"
              >
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="h-14 px-10 text-base font-medium border-primary/30 hover:bg-primary/10"
          ...
          <Card className="glass-card border-primary/20 overflow-hidden">
            <CardContent className="p-8 sm:p-12">
              <div className="text-center mb-10">
                <p 
                  className="inline-block text-xs font-semibold tracking-[0.2em] uppercase text-primary px-4 py-1.5 mb-4"
                  style={{
                ...
                <div className="flex items-center justify-center gap-4 mb-4">
                  ...
                  <span className="text-5xl sm:text-6xl font-bold text-gradient-primary">₹24,999</span>
                </div>
                
                <p className="inline-block bg-success/10 text-success px-4 py-1.5 rounded-full text-sm font-medium border border-success/20">
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-10 max-w-2xl mx-auto">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3 p-3 rounded-lg hover:bg-primary/5 transition-colors">
              ...
              <div className="text-center">
                <Button 
                  size="lg" 
                  onClick={handleGetStarted}
                  className="btn-gradient h-14 px-12 text-base font-semibold w-full sm:w-auto glow-cyan"
                >
                  <Sparkles className="h-4 w-4 mr-2" />
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={idx} className="glass-card border-primary/10 hover-lift">
                <CardContent className="p-8">
                  <div className="mb-6 inline-flex p-3 rounded-xl bg-primary/10 border border-primary/20">
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {activeCodexes.map((codex, idx) => (
                <div 
                  key={idx}
                  className="p-4 rounded-lg glass-card border-primary/10 hover:border-primary/30 transition-colors"
                >
      ...
      <section className="py-24 px-4 bg-card/30">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <Button 
            size="lg" 
            onClick={handleGetStarted}
            className="btn-gradient h-14 px-12 text-base font-semibold glow-cyan"
          >
            <Sparkles className="h-4 w-4 mr-2" />
            Get Started Now
          </Button>
