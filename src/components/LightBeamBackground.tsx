...
export const LightBeamBackground = () => {
  ...
  const orbs = useMemo(() => [
    { id: 1, color: "160 84% 39%", size: 600, x: "20%", y: "20%", opacity: 0.06 },
    { id: 2, color: "172 66% 50%", size: 500, x: "80%", y: "30%", opacity: 0.05 },
    { id: 3, color: "186 72% 45%", size: 400, x: "50%", y: "80%", opacity: 0.04 },
  ], []);
